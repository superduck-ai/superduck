...
var toolDefinitions = []toolDefinition{
	...
	},
	{
		...
		inputSchema: objectSchema(map[string]any{
			...
			"format":    stringSchema("Output format: 'text' (plain text, default), 'html' (raw innerHTML of the content area), 'markdown' (structured markdown).", withEnum("text", "html", "markdown")),
		}, "tabId"),
	},
	{
		name:        "read_page",
